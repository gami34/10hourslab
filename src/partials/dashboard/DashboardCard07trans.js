        ...
        <div className="overflow-x-auto">
          <table className="table-auto w-full">
            ...
            <thead className="text-xs uppercase text-gray-400 bg-gray-50 rounded-sm">
              <tr>
                {props.data[0] && props.data[0].id && (<th className="p-2">
                  <div className="font-semibold text-left">ID</div>
                </th>)}
                {props.data[0].first_name && (<th className="p-2">
                  <div className="font-semibold text-left">First Name</div>
                </th>)}
                {props.data[0].last_name && (<th className="p-2">
                  <div className="font-semibold text-left">Last Name</div>
                </th>)}
                {props.data[0].created_at && (<th className="p-2">
                  <div className="font-semibold text-left">Created At</div>
                </th>)}
                {props.data[0].updated_at && (<th className="p-2">
