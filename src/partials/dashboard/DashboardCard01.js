  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-lg rounded-sm border border-gray-200">
      <div className="px-5 pt-5">
        ...
        <h2 className="text-lg font-semibold text-gray-800 mb-2">{props.displayHeader}</h2>
        <h4 className="text-sm uppercase font-semibold text-gray-800 mb-2">{props.displayLowerHeader}</h4>
        <div className="text-xs font-semibold text-gray-400 uppercase mb-1">{props.subDisplayText}</div>
        <div className="flex items-start">
          <div className="text-3xl font-bold text-gray-800 mr-2">{props.displayTotal} Registered</div>
